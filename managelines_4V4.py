...
def manage_lines(Linvf,Linvd,Linhf,Linhd,stamina,line_seq,result,mode,s_player_type,puckposs,line_ticker,penbox):
    ...
    # VISITOR PP
    if Linvf["NUM"] == 1:
        hfs_avg = (stamina["4LWH1"]["4LWH1"][3] + stamina["4CH1"]["4CH1"][3])/2           
    elif Linvf["NUM"] == 2:
        hfs_avg = (stamina["4LWH2"]["4LWH2"][3] + stamina["4CH2"]["4CH2"][3])/2   
    
    if Linvd["NUM"] == 1:
        hds_avg = (stamina["4LDH1"]["4LDH1"][3] + stamina["4RDH1"]["4RDH1"][3])/2  
    elif Linvd["NUM"] == 2:
        hds_avg = (stamina["4LDH2"]["4LDH2"][3] + stamina["4RDH2"]["4RDH2"][3])/2  
   
    # HOME PK
    if Linhf["NUM"] == 1:
        vfs_avg = (stamina["4LWV1"]["4LWV1"][3] + stamina["4CV1"]["4CV1"][3])/2 
    elif Linhf["NUM"] == 2:
        vfs_avg = (stamina["4LWV2"]["4LWV2"][3] + stamina["4CV2"]["4CV2"][3])/2

    if Linhd["NUM"] == 1:
        vds_avg = (stamina["4LDV1"]["4LDV1"][3] + stamina["4RDV1"]["4RDV1"][3])/2 
    elif Linhd["NUM"] == 2:
        vds_avg = (stamina["4LDV2"]["4LDV2"][3] + stamina["4RDV2"]["4RDV2"][3])/2
    ...
    if mode["HOME"] ==0 and mode["VISITOR"] == 0: # PURE AI
       ...
       if "ICING" in s_player_type:     
               ...
               if "ICING_0" in s_player_type: # HOME TEAM ICE PUCK
                    ...
                    if (stamina["4LWV1"]["4LWV1"][3] + stamina["4CV1"]["4CV1"][3])/2 > 60:
                           line_seq["LINVF"] = 1
                    else:
                           line_seq["LINVF"] = 2
                    
                    
                    if (stamina["4LDV1"]["4LDV1"][3] + stamina["4RDV1"]["4RDV1"][3])/2 > 60:
                           line_seq["LINVD"] = 1
                    else:
                           line_seq["LINVD"] = 2           
                    ...
                    if (stamina["4LWH1"]["4LWH1"][3] + stamina["4CH1"]["4CH1"][3])/2 > 60:
                           line_seq["LINHF"] = 1
                    else:
                           line_seq["LINHF"] = 2
                    
                    
                    if (stamina["4LDH1"]["4LDH1"][3] + stamina["4RDH1"]["4RDH1"][3])/2 > 60:
                           line_seq["LINHD"] = 1
                    else:
                           line_seq["LINHD"] = 2           
